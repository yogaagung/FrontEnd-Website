...
@section('maincontent')
<!-- BANNER -->
<div class="blog_banner" style="background: url('/img/blog_details_banner.jpnpg') no-repeat center center">
            ...
            <div class="col-12 col-md-12 col-lg-3">
                <div class="blog_post_r8">
                    ...
                    <div class="post_category">
                        <h3 class="post_category_h3">Categories</h3>
                        <ul class="post_category_ul">
                            @if(count($blog->cat) > 0)
                            @foreach($blog->cat as $c)
                            <li>
                                <a href="/category/{{$c->categoryName}}/{{$c->id}}">{{$c->categoryName}}</a>
